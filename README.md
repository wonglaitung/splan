...
| 规划书场景 | 技术支撑文档 | 关键技术组件 |
|-----------|-------------|-------------|
| **场景A：研发智能助手** | 研发助手说明书 | Context7 MCP Server + Claude Code |
| **场景B：制度百事通** | 接入网关说明书 + Harness说明书 | 知识库 + Guardrails防幻觉 |
| **场景A：信贷尽调助理** | Harness说明书 | Skill驱动 + MCP数据中台连接 |
| **场景B：智能支付路由** | Harness说明书 | Agent决策 + Spring Cloud编排 |
| **场景A：智能财资管理** | Harness说明书 | 多Agent协同 + 预测引擎 |
| **场景B：财富领航系统** | Harness说明书 | 多Agent网络 + Client工作台 |

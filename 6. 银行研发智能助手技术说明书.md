...
| 组件 | 角色 | 回答的核心问题 | 对应章节 |
|------|------|---------------|---------|
| **Context7 知识库（MCP）** | 查得准 | AI 认不认识内部规范？会不会凭通用知识猜测 | 第五章（Context7 MCP 服务端实现） |
